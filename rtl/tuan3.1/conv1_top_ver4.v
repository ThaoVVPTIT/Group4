...
// ============================================================================
// MODULE: conv1_top_ver1 (Streaming Standard - Không dùng Generate)
// Ch?c n?ng: Top-level Tích ch?p Conv1 (28x28x1 -> 26x26x6)
//            X? tr?c ti?p Stream sang Streaming Pooling (Zero-BRAM Conv1).
// ============================================================================
...
module conv1_top_ver4 #(
    ...
    // GIAO DI?N AXI-STREAM OUTPUT (X? SANG POOLING IP - ZERO BRAM CONV1)
    ...
    assign m_axis_frame_clear = frame_clear; // N?i xung clear sang pool_start

    // Gate nh?n pixel: Ch? cho phép nh?n khi h? th?ng ?ang BUSY
    ...
    // ========================================================================
    // 4. INSTANTIATE 6 KH?I PE (KHÔNG DÙNG GENERATE)
    // ========================================================================
    conv1_pe u_pe_0 (
    ...
    // ========================================================================
    // 5. DIRECT AXI-STREAM OUTPUT ASSIGNMENT (X? TH?NG SANG POOLING)
    // ========================================================================
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            // ??m ?? 676 patches x? sang Pooling thì hoàn thành Conv1
            if (pe_valid[0]) begin
