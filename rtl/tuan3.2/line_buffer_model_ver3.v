...
// ============================================================================
// MODULE: line_buffer_model_ver3 (?Ã FIX TRI?T ?? L?I THI?U PATCH CU?I)
// ============================================================================
...
module line_buffer_model_ver3 #(
    ...
    // FIX: rows_valid duy trì chu?n xác ngay khi n?p ?? 2 dòng ??u (row_phase == 2'b10)
    assign rows_valid = pixel_valid && (row_phase == 2'b10);
            ...
            if (pixel_valid) begin
                ...
                if (col_cnt == IMG_WIDTH - 1) begin
                    ...
                    if (row_cnt == IMG_HEIGHT - 1) begin
                        row_cnt       <= {ROW_CNT_WIDTH{1'b0}};
                        chan_end_tick <= 1'b1;
                        // Gi? nguyên row_phase = 2'b10 ?? không làm s?p rows_valid ? pixel cu?i
                    end else begin
                        row_cnt <= row_cnt + 1'b1;
                    end
                end else begin
