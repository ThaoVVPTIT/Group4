...
REM
REM Generated by Vivado on Tue Aug 11 17:06:37 +0700 2026
...
echo "xvlog --incr --relax -prj tb_ws_dataflow_vlog.prj"
call xvlog  --incr --relax -prj tb_ws_dataflow_vlog.prj -log xvlog.log
